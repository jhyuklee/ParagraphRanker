...
class DocRanker(object):
    GROUP_LENGTH = 0
    """Loads a pre-weighted inverted index of token/document terms.
    Scores new queries by taking sparse dot products.
    """

    def __init__(self, encoder, reader_name, db_path, tfidf_path=None, strict=True,
        ...
        annotators = tokenizers.get_annotators_for_model(self.encoder)
    ...
    def _get_encoder_loader(self, data, num_loaders):
        ...
        dataset = ReaderDataset(data, self.encoder, 1, 1000)
    ...
    def rank_docs(self, queries, answers, candidates=None, n_docs=5, n_pars=10):
        ...
        for batch in self._get_encoder_loader(examples, num_loaders):
            doc_encoded, q_encoded = self.encoder.encode(batch)
